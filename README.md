# apiFly OpenAPI Specification
[![Build Status](https://travis-ci.org/alexRaso89/openApiFly.svg?branch=master)](https://travis-ci.org/alexRaso89/openApiFly)
...
6. If you did everything correct, https://alexraso89.github.io/openApiFly/ will lead to your new docs
...
- Documentation(ReDoc): https://alexraso89.github.io/openApiFly/
- SwaggerUI: https://alexraso89.github.io/openApiFly/swagger-ui/
- Look full spec:
    + JSON https://alexraso89.github.io/openApiFly/swagger.json
    + YAML https://alexraso89.github.io/openApiFly/swagger.yaml
- Preview spec version for branch `[branch]`: https://alexraso89.github.io/openApiFly/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://alexraso89.github.io/openApiFly/ with url from the message: `Server started <url>`
